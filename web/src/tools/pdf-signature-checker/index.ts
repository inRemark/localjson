...
export const tool = defineTool({
  name: translate('tools.pdf-signature-checker.name'),
  title: translate('tools.pdf-signature-checker.title'),
  path: '/pdf-signature-checker',
  description: translate('tools.pdf-signature-checker.description'),
  keywords: translate('tools.pdf-signature-checker.keywords'),
